...
public:
	...
	Mesh(vector<Vertex> vertices, vector<unsigned int> indices, vector<model_Texture> textures)
	{
...
private:
	...
	void setupMesh()
	{
		...
		glVertexAttribPointer(5, 4, GL_FLOAT, GL_FALSE, sizeof(Vertex), (const void*)offsetof(Vertex, m_BoneIDs));
